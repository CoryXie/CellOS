...
void x64_idt_init(void)
    ...
    for(i = 0; i < INTR_COUNT_MAX ; i++)
        x64_idt_set_entry(i,(uint64_t)&_x64_isr_reserved,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);


    x64_idt_set_entry(0,(uint64_t)&_x64_isr0,GDT_SEL_KERNEL_CS,TRAP_GATE_FLAGS);
    x64_idt_set_entry(1,(uint64_t)&_x64_isr1,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(2,(uint64_t)&_x64_isr2,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(3,(uint64_t)&_x64_isr3,GDT_SEL_KERNEL_CS,TRAP_GATE_FLAGS);
    x64_idt_set_entry(4,(uint64_t)&_x64_isr4,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(5,(uint64_t)&_x64_isr5,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(6,(uint64_t)&_x64_isr6,GDT_SEL_KERNEL_CS,TRAP_GATE_FLAGS);
    x64_idt_set_entry(7,(uint64_t)&_x64_isr7,GDT_SEL_KERNEL_CS,TRAP_GATE_FLAGS);
    x64_idt_set_entry(8,(uint64_t)&_x64_isr8,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(9,(uint64_t)&_x64_isr9,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(10,(uint64_t)&_x64_isr10,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(11,(uint64_t)&_x64_isr11,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(12,(uint64_t)&_x64_isr12,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(13,(uint64_t)&_x64_isr13,GDT_SEL_KERNEL_CS,TRAP_GATE_FLAGS);
    x64_idt_set_entry(14,(uint64_t)&_x64_isr14,GDT_SEL_KERNEL_CS,TRAP_GATE_FLAGS);
    x64_idt_set_entry(15,(uint64_t)&_x64_isr15,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(16,(uint64_t)&_x64_isr16,GDT_SEL_KERNEL_CS,TRAP_GATE_FLAGS);
    x64_idt_set_entry(17,(uint64_t)&_x64_isr17,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(18,(uint64_t)&_x64_isr18,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(19,(uint64_t)&_x64_isr19,GDT_SEL_KERNEL_CS,TRAP_GATE_FLAGS);
    x64_idt_set_entry(20,(uint64_t)&_x64_isr20,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(21,(uint64_t)&_x64_isr21,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(22,(uint64_t)&_x64_isr22,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(23,(uint64_t)&_x64_isr23,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(24,(uint64_t)&_x64_isr24,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(25,(uint64_t)&_x64_isr25,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(26,(uint64_t)&_x64_isr26,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(27,(uint64_t)&_x64_isr27,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(28,(uint64_t)&_x64_isr28,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(29,(uint64_t)&_x64_isr29,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(30,(uint64_t)&_x64_isr30,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(31,(uint64_t)&_x64_isr31,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(32,(uint64_t)&_x64_isr32,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(33,(uint64_t)&_x64_isr33,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(34,(uint64_t)&_x64_isr34,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(35,(uint64_t)&_x64_isr35,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(36,(uint64_t)&_x64_isr36,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(37,(uint64_t)&_x64_isr37,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(38,(uint64_t)&_x64_isr38,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(39,(uint64_t)&_x64_isr39,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(40,(uint64_t)&_x64_isr40,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(41,(uint64_t)&_x64_isr41,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(42,(uint64_t)&_x64_isr42,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(43,(uint64_t)&_x64_isr43,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(44,(uint64_t)&_x64_isr44,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(45,(uint64_t)&_x64_isr45,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(46,(uint64_t)&_x64_isr46,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(47,(uint64_t)&_x64_isr47,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(128,(uint64_t)&_x64_isr128,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);

    x64_idt_set_entry(0xf0,(uint64_t)&_x64_isr240,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(0xf1,(uint64_t)&_x64_isr241,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(0xf2,(uint64_t)&_x64_isr242,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
    x64_idt_set_entry(0xf3,(uint64_t)&_x64_isr243,GDT_SEL_KERNEL_CS,INTR_GATE_FLAGS);
