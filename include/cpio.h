...
#ifndef _POSIX_CPIO_H
#define _POSIX_CPIO_H
...
/*
 *
 * The <cpio.h> header shall define the symbolic constants needed 
 * by the c_mode field of the cpio archive format.
 */
...
/*
 * The <cpio.h> header shall define the following symbolic
