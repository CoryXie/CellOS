 ...
 *   as so that it can define the order of <object>s. If the object in the
 *   1st parameter is considered to be smaller than the object in the 2nd
 *   parameter, then the object in the 1st parameter will be inserted left.
 */
...
typedef struct rbnode 
    {
    struct rbtree * tree;         /* The tree we are part of */
...
extern void rbnode_init(rbnode_t * node,void * object);
...
extern rbnode_t * rbtree_insert_object(rbtree_t * tree, void * object);
extern rbnode_t * rbtree_insert_successor_object_at(rbtree_t * tree,
                                            rbnode_t * at_node,
                                            void * object);
extern rbnode_t * rbtree_insert_predecessor_object_at(rbtree_t * tree,
                                              rbnode_t * at_node,
                                              void * object);
...
extern void rbtree_remove_node(rbtree_t * tree, rbnode_t * node);
